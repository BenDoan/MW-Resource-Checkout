...
<form action="./?p=resultList" method="get"><input name="p"
	type="hidden" value="resultList" />
	...
	<tr>
		...
		<td><select name="type">
			...
			while($row = $result->fetch_assoc()){
				extract($row);
				echo generateResource($type_name);
			}
			?>
		</select></td>
		<th>Block</th>
		<td><?php echo generateBlock('1');?> <?php echo generateBlock('2');?>
		<?php echo generateBlock('3');?> <?php echo generateBlock('4');?></td>
		<th></th>
